...
class TaskManager:
    ...
    def add_task(self, user_id: str, title: str, description: str = None) -> AddTaskResponse:
        ...
        Example usage:
        >>> manager = TaskManager()
        >>> result = manager.add_task("user123", "Buy groceries", "Need to buy milk and bread")
...
if __name__ == "__main__":
    ...
    async def example():
        ...
        print(f"Add task result: {add_resp.success}, Data: {add_resp.data}")

        # List tasks
        list_req = ListTasksRequest(user_id="test_user", status="all")
        list_resp = await list_tasks(list_req)
        print(f"List tasks result: {list_resp.success}, Data: {list_resp.data}")
        ...
        if list_resp.success and list_resp.data and list_resp.data['tasks']:
            ...
            print(f"Complete task result: {complete_resp.success}, Data: {complete_resp.data}")
            ...
            print(f"Update task result: {update_resp.success}, Data: {update_resp.data}")

            # Delete the task
            delete_req = DeleteTaskRequest(user_id="test_user", task_id=task_id)
            delete_resp = await delete_task(delete_req)
            print(f"Delete task result: {delete_resp.success}, Data: {delete_resp.data}")
